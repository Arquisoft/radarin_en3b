export const HelpItems = [
    ...
    },
    {
        ...
        fullText: "After login in on the web, open the application on your mobile. Then, on the web, press on your account name and then on 'QR'. Now, scan the QR which appears on the screen from the mobile application and... Voilà!",
    },
    {
